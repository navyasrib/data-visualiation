...
(function (t, n) {
    ...
    function Kt(t) {
        ...
        var e = un(t.r), r = un(t.g), i = un(t.b), o = en((.4124564 * e + .3575761 * r + .1804375 * i) / Uh), u = en((.2126729 * e + .7151522 * r + .072175 * i) / Dh), a = en((.0193339 * e + .119192 * r + .9503041 * i) / Oh);
    ...
    function fn(t) {
        ...
        t instanceof Wt || (t = Xt(t));
        var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Gh * r + $h * n - Zh * e) / (Gh + $h - Zh), o = r - i, u = (Wh * (e - i) - Xh * o) / Vh, a = Math.sqrt(u * u + o * o) / (Wh * i * (1 - i)), c = a ? Math.atan2(u, o) * Lh - 120 : NaN;
    ...
    function Tn(t, n, e, r) {
        ...
        function o(t, r, i, o, u, a) {
            if (t !== i || r !== o) {
                ...
                a.push({i: c - 4, x: sp(t, i)}, {i: c - 2, x: sp(r, o)})
        ...
        function c(t, n, e, r, o, u) {
            if (t !== e || n !== r) {
                ...
                u.push({i: a - 4, x: sp(t, e)}, {i: a - 2, x: sp(n, r)})
    ...
    function qr(t, n, r, i, o, u, a, c, s) {
        ...
        function l(n, r, i, o) {
            if (null == n && (n = 10), "number" == typeof n) {
                var u = Math.abs(i - r) / n, a = ws(function (t) {
                    return t[2]
                }).right(M, u);
        ...
        var h = dr(cr, sp), p = h.invert, d = h.domain, v = s(".%L"), _ = s(":%S"), y = s("%I:%M"), g = s("%I %p"), m = s("%a %d"), x = s("%b %d"), b = s("%B"), w = s("%Y"), M = [[a, 1, Jv], [a, 5, 5 * Jv], [a, 15, 15 * Jv], [a, 30, 30 * Jv], [u, 1, Qv], [u, 5, 5 * Qv], [u, 15, 15 * Qv], [u, 30, 30 * Qv], [o, 1, Kv], [o, 3, 3 * Kv], [o, 6, 6 * Kv], [o, 12, 12 * Kv], [i, 1, t_], [i, 2, 2 * t_], [r, 1, n_], [n, 1, e_], [n, 3, 3 * e_], [t, 1, r_]];
    ...
    function eo(t, n) {
        var e, r, i;
        return function () {
            var o = ey(this).getComputedStyle(this, null), u = o.getPropertyValue(t), a = (this.style.removeProperty(t), o.getPropertyValue(t));
    ...
    function oo(t, n, e) {
        var r, i, o;
        return function () {
            var u = ey(this).getComputedStyle(this, null), a = u.getPropertyValue(t), c = e(this);
    ...
    function ho(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);)if (!(t = t.parentNode))return Ky.time = jn(), Ky;
        return e
    }
    ...
    function mu(t, n) {
        var e = t.document.documentElement, r = _y(t).on("dragstart.drag", null);
    ...
    function Yu() {
        for (var t, n, e, r, i = 0, o = om.length; i < o; ++i)if ((t = om[i]) && (r = (n = t.halfedges).length)) {
    ...
    function Bu(t, n, e, r) {
        var i, o, u, a, c, s, f, l, h, p, d, v, _ = om.length, y = !0;
        for (i = 0; i < _; ++i)if (o = om[i]) {
    ...
    function Hu(t) {
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (!(h >= -lm)) {
                    var p = c * c + s * s, d = f * f + l * l, v = (l * p - s * d) / h, _ = (c * d - f * p) / h, y = cm.pop() || new ju;
                    y.arc = t, y.site = i, y.x = v + u, y.y = (y.cy = _ + a) + Math.sqrt(v * v + _ * _), t.circle = y;
                    for (var g = null, m = um._; m;)if (y.y < m.y || y.y === m.y && y.x <= m.x) {
                        if (!m.L) {
                            g = m.P;
                            break
                        }
    ...
    function Gu(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = im._; a;)if (r = Ju(a, u) - o, r > fm)a = a.L; else {
            if (i = o - Qu(a, u), !(i > fm)) {
    ...
    function na(t, n) {
        ...
        for (am = [], om = new Array(t.length), im = new ku, um = new ku; ;)if (i = rm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))o[0] === e && o[1] === r || (Gu(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i)break;
            Zu(i.arc)
        }
        if (Yu(), n) {
    ...
    function ga(n) {
        ...
        function r() {
            var t = _y(this), n = pa(this).selection;
        ...
        function u() {
            ...
            if (f.apply(this, arguments)) {
                var l, h, p, d, v, _, y, g, m, x, b, w, M, T = this, N = t.event.target.__data__.type, k = "selection" === (t.event.metaKey ? N = "overlay" : N) ? xm : t.event.altKey ? Mm : wm, S = n === Nm ? null : Cm[N], A = n === Tm ? null : zm[N], E = pa(T), C = E.extent, z = E.selection, P = C[0][0], q = C[0][1], L = C[1][0], R = C[1][1], U = S && A && t.event.shiftKey, D = L_(T), O = D, F = i(T, arguments).beforestart();
                "overlay" === N ? E.selection = z = [[l = n === Nm ? P : D[0], p = n === Tm ? q : D[1]], [v = n === Nm ? L : l, y = n === Tm ? R : p]] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
                var I = _y(T).attr("pointer-events", "none"), Y = I.selectAll(".overlay").attr("cursor", Sm[N]);
        ...
        return e.move = function (t, e) {
            t.selection ? t.on("start.brush", function () {
                ...
                var o = this, u = o.__brush, a = i(o, arguments), c = u.selection, s = n.input("function" == typeof e ? e.apply(this, arguments) : e, u.extent), f = dp(c, s);
                return c && s ? t : t(1)
            }) : t.each(function () {
    ...
    function Da(t, n) {
        t *= Ex, n *= Ex, n = n / 2 + kx;
        var e = t - Vm, r = e >= 0 ? 1 : -1, i = r * e, o = qx(n), u = Ox(n), a = $m * u, c = Wm * o + a * qx(i), s = a * r * Ox(i);
    ...
    function Va(t, n) {
        var e = Fa([t * Ex, n * Ex]);
        if (ex) {
            var r = Ya(ex, e), i = [r[1], -r[0], 0], o = Ya(i, r);
            Ha(o), o = Oa(o);
            var u, a = t - Km, c = a > 0 ? 1 : -1, s = o[0] * Ax * c, f = Cx(a) > 180;
    ...
    function oc(t, n) {
        t *= Ex, n *= Ex;
        var e = qx(n), r = e * qx(t), i = e * Ox(t), o = Ox(n), u = Px(Ix((u = mx * o - xx * i) * u + (u = xx * r - gx * o) * u + (u = gx * i - mx * r) * u), gx * r + mx * i + xx * o);
    ...
    function fc(t, n) {
        t *= Ex, n *= Ex;
        var e = qx(n), r = e * qx(t), i = e * Ox(t), o = Ox(n), u = mx * o - xx * i, a = xx * r - gx * o, c = gx * i - mx * r, s = Ix(u * u + a * a + c * c), f = gx * r + mx * i + xx * o, l = s && -Sa(f) / s, h = Px(s, f);
    ...
    function vc(t, n) {
        function e(t, n) {
            var e = qx(n), a = qx(t) * e, c = Ox(t) * e, s = Ox(n), f = s * r + a * i;
            return [Px(c * o - f * u, a * r - s * i), Aa(f * o + c * u)]
        }

        var r = qx(t), i = Ox(t), o = qx(n), u = Ox(n);
        return e.invert = function (t, n) {
            var e = qx(n), a = qx(t) * e, c = Ox(t) * e, s = Ox(n), f = s * o - c * u;
        ...
        return function (u) {
            ...
            function d(o, u) {
                ...
                if (_ && y.push([o, u]), T)g = o, m = u, x = a, T = !1, a && (k.lineStart(), k.point(o, u)); else if (a && M)k.point(o, u); else {
                    var c = [b = Math.max(xb, Math.min(mb, b)), w = Math.max(xb, Math.min(mb, w))], s = [o = Math.max(xb, Math.min(mb, o)), u = Math.max(xb, Math.min(mb, u))];
                    _b(c, s, t, n, e, r) ? (M || (k.lineStart(), k.point(c[0], c[1])), k.point(s[0], s[1]), a || k.lineEnd(), N = !1) : a && (k.lineStart(), k.point(o, u), N = !1)
                }
                b = o, w = u, M = a
            }

            var v, _, y, g, m, x, b, w, M, T, N, k = u, S = vb(), A = {
                point: c,
                lineStart: h,
                lineEnd: p,
                polygonStart: f,
    ...
    function Tc(t, n) {
        t *= Ex, n *= Ex;
        var e = Ox(n), r = qx(n), i = Cx(t - eb), o = qx(i), u = Ox(i), a = r * u, c = ib * e - rb * r * o, s = rb * e + ib * r * o;
    ...
    function Rc(t, n) {
        var e = t - lb, r = n - hb, i = Ix(e * e + r * r);
    ...
    function $c(t, n, e, r) {
        var i;
        if (null == t)i = e * Nx, r.point(-Tx, i), r.point(0, i), r.point(Tx, i), r.point(Tx, 0), r.point(Tx, -i), r.point(0, -i), r.point(-Tx, -i), r.point(-Tx, 0), r.point(-Tx, i); else if (Cx(t[0] - n[0]) > wx) {
            var o = t[0] < n[0] ? Tx : -Tx;
    ...
    function Jc(t, n, e) {
        ...
        var u = Ob.result(), a = Math.min(r / (u[1][0] - u[0][0]), i / (u[1][1] - u[0][1])), c = +n[0][0] + (r - a * (u[1][0] + u[0][0])) / 2, s = +n[0][1] + (i - a * (u[1][1] + u[0][1])) / 2;
    ...
    function ns(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h, b = a + p, w = c + d, M = Ix(x * x + b * b + w * w), T = Aa(w /= M), N = Cx(Cx(w) - 1) < wx || Cx(o - l) < wx ? (o + l) / 2 : Px(b, x), k = t(N, T), S = k[0], A = k[1], E = S - r, C = A - i, z = g * E - y * C;
    ...
    function rs(t) {
        ...
        var u, a, c, s, f, l, h, p, d, v, _ = 150, y = 480, g = 250, m = 0, x = 0, b = 0, w = 0, M = 0, T = null, N = Kb, k = null, S = Cb, A = .5, E = iw(r, A);
    ...
    function us(t, n) {
        ...
        var r = Ox(t), i = (r + Ox(n)) / 2;
        if (Cx(i) < wx)return os(t);
        var o = 1 + r * (2 * i - r), u = Ix(o) / i;
        return e.invert = function (t, n) {
            var e = u - n;
    ...
    function ss(t) {
        return function (n, e) {
            var r = Ix(n * n + e * e), i = t(r), o = Ox(i), u = qx(i);
    ...
    function ls(t) {
        var n, e = es(t), r = e.scale, i = e.translate, o = e.clipExtent;
        return e.scale = function (t) {
    ...
    function ps(t, n) {
        ...
        var r = qx(t), i = t === n ? Ox(t) : Ux(r / qx(n)) / Ux(hs(n) / hs(t)), o = r * Dx(hs(t), i) / i;
        return i ? (e.invert = function (t, n) {
            var e = o - n, r = Fx(i) * Ix(t * t + e * e);
    ...
    function vs(t, n) {
        ...
        var r = qx(t), i = t === n ? Ox(t) : (r - qx(n)) / (n - t), o = r / i + t;
    ...
    var xs = "4.2.7", bs = function (t, n) {
    ...
    }, Ms = ws(bs), Ts = Ms.right, Ns = Ms.left, ks = function (t, n) {
        return n < t ? -1 : n > t ? 1 : n >= t ? 0 : NaN
    }, Ss = function (t) {
        return null === t ? NaN : +t
    }, As = function (t, n) {
        var e, r, i = t.length, o = 0, u = 0, a = -1, c = 0;
        if (null == n)for (; ++a < i;)isNaN(e = Ss(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o)); else for (; ++a < i;)isNaN(e = Ss(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
        if (c > 1)return u / (c - 1)
    }, Es = function (t, n) {
        var e = As(t, n);
        ...
        return [e, i]
    }, zs = Array.prototype, Ps = zs.slice, qs = zs.map, Ls = function (t) {
        return function () {
            return t
        }
    }, Rs = function (t) {
        ...
        return o
    }, Ds = Math.sqrt(50), Os = Math.sqrt(10), Fs = Math.sqrt(2), Is = function (t, n, r) {
        var i = e(t, n, r);
        ...
        if (null == n)for (; ++o < i;)isNaN(e = Ss(t[o])) ? --u : r += e; else for (; ++o < i;)isNaN(e = Ss(n(t[o], o, t))) ? --u : r += e;
        if (u)return r / u
    }, $s = function (t, n) {
        var e, r = [], i = t.length, o = -1;
        if (null == n)for (; ++o < i;)isNaN(e = Ss(t[o])) || r.push(e); else for (; ++o < i;)isNaN(e = Ss(n(t[o], o, t))) || r.push(e);
        ...
        for (var n = -1, e = Gs(t, r), i = new Array(e); ++n < e;)for (var o, u = -1, a = i[n] = new Array(o); ++u < o;)a[u] = t[u][n];
        return i
    }, rf = function () {
        return ef(arguments)
    }, of = "$";
    i.prototype = o.prototype = {
        constructor: i, has: function (t) {
            ...
            var t = [];
            for (var n in this)n[0] === of && t.push({key: n.slice(1), value: this[n]});
            return t
        }, size: function () {
            var t = 0;
            ...
            for (var t in this)if (t[0] === of)return !1;
            return !0
        }, each: function (t) {
    ...
    f.prototype = l.prototype = {
        constructor: f, has: af.has, add: function (t) {
            return t += "", this[of + t] = t, this
        }, remove: af.remove, clear: af.clear, values: af.keys, size: af.size, empty: af.empty, each: af.each
    };
    var cf = function (t) {
        var n = [];
        ...
        return n = +n, e.exponent = t, e
    }(yf), bf = Math.PI, wf = bf / 2, Mf = 4 / 11, Tf = 6 / 11, Nf = 8 / 11, kf = .75, Sf = 9 / 11, Af = 10 / 11, Ef = .9375, Cf = 21 / 22, zf = 63 / 64, Pf = 1 / Mf / Mf, qf = 1.70158, Lf = function t(n) {
        function e(t) {
            return t * t * ((n + 1) * t - n)
        }
        ...
        return n = +n, e.overshoot = t, e
    }(qf), Df = 2 * Math.PI, Of = 1, Ff = .3, If = function t(n, e) {
        function r(t) {
        ...
        return c
    }, Zf = Math.PI, Gf = 2 * Zf, Jf = 1e-6, Qf = Gf - Jf;
    q.prototype = L.prototype = {
        constructor: q, moveTo: function (t, n) {
            ...
            if (null === this._x1)this._.push("M", this._x1 = t, ",", this._y1 = n); else if (l > Jf)if (Math.abs(f * a - c * s) > Jf && i) {
                var h = e - o, p = r - u, d = a * a + c * c, v = h * h + p * p, _ = Math.sqrt(d), y = Math.sqrt(l), g = i * Math.tan((Zf - Math.acos((d + l - v) / (2 * _ * y))) / 2), m = g / y, x = g / _;
    ...
    var Kf = function (t) {
        ...
        for (v && d.push(new rl(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();)if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l))if (v.length) {
            var _ = (i + u) / 2, y = (o + a) / 2;
        ...
        for (c && a.push(new rl(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();)if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
            var s = (r + o) / 2, f = (i + u) / 2;
    ...
    var vl = function (t) {
    ...
    }, _l = 1e-12, yl = Math.PI, gl = yl / 2, ml = 2 * yl, xl = function () {
        function t() {
            var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - gl, p = u.apply(this, arguments) - gl, d = Math.abs(p - h), v = p > h;
            if (c || (c = t = L()), l < f && (s = l, l = f, f = s), l > _l)if (d > ml - _l)c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _l && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v)); else {
                var _, y, g = h, m = p, x = h, b = p, w = d, M = d, T = a.apply(this, arguments) / 2, N = T > _l && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l)), k = Math.min(Math.abs(l - f) / 2, +r.apply(this, arguments)), S = k, A = k;
                if (N > _l) {
                ...
                if (k > _l) {
                    ...
                    if (d < yl) {
                        var I = w > _l ? et(z, P, O, F, U, D, q, R) : [q, R], Y = z - I[0], B = P - I[1], j = U - I[0], H = D - I[1], X = 1 / Math.sin(Math.acos((Y * j + B * H) / (Math.sqrt(Y * Y + B * B) * Math.sqrt(j * j + H * H))) / 2), V = Math.sqrt(I[0] * I[0] + I[1] * I[1]);
        ...
        var n = G, e = J, r = vl(0), i = null, o = Q, u = K, a = tt, c = null;
        return t.centroid = function () {
            var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2, r = (+o.apply(this, arguments) + +u.apply(this, arguments)) / 2 - yl / 2;
    ...
    var bl = function (t) {
        ...
        var n = ot, e = ut, r = vl(!0), i = null, o = bl, u = null;
        ...
        var e = ot, r = null, i = vl(0), o = ut, u = vl(!0), a = null, c = bl, s = null;
        ...
        function t(t) {
            var a, c, s, f, l, h = t.length, p = 0, d = new Array(h), v = new Array(h), _ = +i.apply(this, arguments), y = Math.min(ml, Math.max(-ml, o.apply(this, arguments) - _)), g = Math.min(Math.abs(y) / h, u.apply(this, arguments)), m = g * (y < 0 ? -1 : 1);
        ...
        var n = Nl, e = Tl, r = null, i = vl(0), o = vl(ml), u = vl(0);
        return t.value = function (e) {
            return arguments.length ? (n = "function" == typeof e ? e : vl(+e), t) : n
    ...
    var Al = function () {
        ...
        var t = Ml().curve(Sl), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    }, Pl = Math.sqrt(1 / 3), ql = 2 * Pl, Ll = {
        draw: function (t, n) {
            var e = Math.sqrt(n / ql), r = e * Pl;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, Rl = .8908130915292852, Ul = Math.sin(yl / 10) / Math.sin(7 * yl / 10), Dl = Math.sin(ml / 10) * Ul, Ol = -Math.cos(ml / 10) * Ul, Fl = {
        draw: function (t, n) {
            var e = Math.sqrt(n * Rl), r = Dl * e, i = Ol * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var u = ml * o / 5, a = Math.cos(u), c = Math.sin(u);
    ...
    }, jl = -.5, Hl = Math.sqrt(3) / 2, Xl = 1 / Math.sqrt(12), Vl = 3 * (Xl / 2 + 1), Wl = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Vl), r = e / 2, i = e * Xl, o = r, u = e * Xl + e, a = -o, c = u;
    ...
    ht.prototype = {
        areaStart: Gl, areaEnd: Gl, lineStart: function () {
    ...
    var sh = function (t) {
        return new Rt(t, .5)
    }, fh = Array.prototype.slice, lh = function (t, n) {
        ...
        var n, e, r = t.length, i = t.map(Ft), o = hh(t).sort(function (t, n) {
            return i[n] - i[t]
        }), u = 0, a = 0, c = [], s = [];
    ...
    }, wh = .7, Mh = 1 / wh, Th = /^#([0-9a-f]{3})$/, Nh = /^#([0-9a-f]{6})$/, kh = /^rgb\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*\)$/, Sh = /^rgb\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/, Ah = /^rgba\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/, Eh = /^rgba\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/, Ch = /^hsl\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/, zh = /^hsla\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/, Ph = {
        aliceblue: 15792383,
    ...
    var qh = Math.PI / 180, Lh = 180 / Math.PI, Rh = 18, Uh = .95047, Dh = 1, Oh = 1.08883, Fh = 4 / 29, Ih = 6 / 29, Yh = 3 * Ih * Ih, Bh = Ih * Ih * Ih;
    bh(nn, tn, It(Yt, {
        brighter: function (t) {
    ...
    var jh = -.14861, Hh = 1.78277, Xh = -.29227, Vh = -.90649, Wh = 1.97294, $h = Wh * Vh, Zh = Wh * Hh, Gh = Hh * Xh - Vh * jh;
    bh(hn, ln, It(Yt, {
        brighter: function (t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * qh, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n), r = Math.cos(t), i = Math.sin(t);
    ...
    var Jh, Qh, Kh, tp, np = function (t) {
        ...
        var r = yn(n);
        return e.gamma = t, e
    }(1), op = mn(np), up = mn(ep), ap = function (t, n) {
    ...
    }, lp = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, hp = new RegExp(lp.source, "g"), pp = function (t, n) {
        var e, r, i, o = lp.lastIndex = hp.lastIndex = 0, u = -1, a = [], c = [];
        for (t += "", n += ""; (e = lp.exec(t)) && (r = hp.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
            i: u,
            x: sp(e, r)
        })), o = hp.lastIndex;
    ...
    }, mp = Tn(wn, "px, ", "px)", "deg)"), xp = Tn(Mn, ", ", ")", ")"), bp = Math.SQRT2, wp = 2, Mp = 4, Tp = 1e-12, Np = function (t, n) {
        ...
        if (h < Tp)r = Math.log(s / u) / bp, e = function (t) {
            ...
            var p = Math.sqrt(h), d = (s * s - u * u + Mp * h) / (2 * u * wp * p), v = (s * s - u * u - Mp * h) / (2 * s * wp * p), _ = Math.log(Math.sqrt(d * d + 1) - d), y = Math.log(Math.sqrt(v * v + 1) - v);
            r = (y - _) / bp, e = function (t) {
                var n = t * r, e = Nn(_), a = u / (wp * p) * (e * Sn(bp * n + _) - kn(_));
                return [i + a * f, o + a * l, u * e / Nn(bp * n + _)]
            }
        }
        return e.duration = 1e3 * r, e
    }, kp = An(_n), Sp = An(gn), Ap = Cn(_n), Ep = Cn(gn), Cp = zn(_n), zp = zn(gn), Pp = function (t, n) {
    ...
    }, Dp = Up(","), Op = Dp.parse, Fp = Dp.parseRows, Ip = Dp.format, Yp = Dp.formatRows, Bp = Up("\t"), jp = Bp.parse, Hp = Bp.parseRows, Xp = Bp.format, Vp = Bp.formatRows, Wp = function (t, n) {
        function e(t) {
            var n, e = f.status;
    ...
    }, td = Kp("text/csv", Op), nd = Kp("text/tab-separated-values", jp), ed = 0, rd = 0, id = 0, od = 1e3, ud = 0, ad = 0, cd = 0, sd = "object" == typeof performance && performance.now ? performance : Date, fd = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function (t) {
        setTimeout(t, 17)
    };
    ...
    }, pd = new Date, dd = new Date, vd = Qn(function () {
    }, function (t, n) {
        t.setTime(+t + n)
    }, function (t, n) {
        return n - t
    ...
    var _d = vd.range, yd = 1e3, gd = 6e4, md = 36e5, xd = 864e5, bd = 6048e5, wd = Qn(function (t) {
        ...
        return t.getDate() - 1
    }), Ed = Ad.range, Cd = Kn(0), zd = Kn(1), Pd = Kn(2), qd = Kn(3), Ld = Kn(4), Rd = Kn(5), Ud = Kn(6), Dd = Cd.range, Od = zd.range, Fd = Pd.range, Id = qd.range, Yd = Ld.range, Bd = Rd.range, jd = Ud.range, Hd = Qn(function (t) {
    ...
    var Wd = Vd.range, $d = Qn(function (t) {
        t.setUTCSeconds(0, 0)
    }, function (t, n) {
        t.setTime(+t + n * gd)
    }, function (t, n) {
    ...
    }), Kd = Qd.range, tv = te(0), nv = te(1), ev = te(2), rv = te(3), iv = te(4), ov = te(5), uv = te(6), av = tv.range, cv = nv.range, sv = ev.range, fv = rv.range, lv = iv.range, hv = ov.range, pv = uv.range, dv = Qn(function (t) {
    ...
    var yv, gv = _v.range, mv = function (t, n) {
        ...
        var e = mv(t, n);
        if (!e)return t + "";
        var r = e[0], i = e[1], o = i - (yv = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, u = r.length;
        ...
        "": wv, "%": function (t, n) {
            ...
            return Tv(100 * t, n)
        }, r: Tv, s: Mv, X: function (t) {
            return Math.round(t).toString(16).toUpperCase()
        }, x: function (t) {
            return Math.round(t).toString(16)
        }
    }, kv = /^(?:(.)?([<>=^]))?([+\-\( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?([a-z%])?$/i, Sv = function (t) {
        return new ne(t)
    };
    ne.prototype.toString = function () {
        return this.fill + this.align + this.sign + this.symbol + (this.zero ? "0" : "") + (null == this.width ? "" : Math.max(1, 0 | this.width)) + (this.comma ? "," : "") + (null == this.precision ? "" : "." + Math.max(0, 0 | this.precision)) + this.type
    };
    var Av, Ev = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"], Cv = function (t) {
        function n(t) {
            function n(t) {
                var n, i, c, g = d, m = v;
                if ("c" === p)m = _(t) + m, t = ""; else {
                    ...
                    if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Ev[8 + yv / 3] : "") + (x && "(" === a ? ")" : ""), y)for (n = -1, i = t.length; ++n < i;)if (c = t.charCodeAt(n), 48 > c || c > 57) {
            ...
            t = Sv(t);
            var e = t.fill, u = t.align, a = t.sign, c = t.symbol, s = t.zero, f = t.width, l = t.comma, h = t.precision, p = t.type, d = "$" === c ? i[0] : "#" === c && /[boxX]/.test(p) ? "0" + p.toLowerCase() : "", v = "$" === c ? i[1] : /[%p]/.test(p) ? "%" : "", _ = Nv[p], y = !p || /[defgprs%]/.test(p);
        ...
        function e(t, e) {
            var r = n((t = Sv(t), t.type = "f", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(xv(e) / 3))), o = Math.pow(10, -i), u = Ev[8 + i / 3];
            return function (t) {
                return r(o * t) + u
            }
        }

        var r = t.grouping && t.thousands ? bv(t.grouping, t.thousands) : ee, i = t.currency, o = t.decimal;
    ...
    var Fv = "%Y-%m-%dT%H:%M:%S.%LZ", Iv = Date.prototype.toISOString ? er : t.utcFormat(Fv), Yv = +new Date("2000-01-01T00:00:00.000Z") ? rr : t.utcParse(Fv), Bv = Array.prototype, jv = Bv.map, Hv = Bv.slice, Xv = {name: "implicit"}, Vv = function (t) {
        return function () {
            return t
        }
    }, Wv = function (t) {
        return +t
    }, $v = [0, 1], Zv = function (n, r, i) {
    ...
    }, Jv = 1e3, Qv = 60 * Jv, Kv = 60 * Qv, t_ = 24 * Kv, n_ = 7 * t_, e_ = 30 * t_, r_ = 365 * t_, i_ = function () {
    ...
    if (t.event = null, "undefined" != typeof document) {
        ...
        "onmouseenter" in C_ || (E_ = {mouseenter: "mouseover", mouseleave: "mouseout"})
    }
    ...
    var oy = function (t, n) {
        ...
        var e = "function" == typeof t ? t : M_(t), r = null == n ? ki : "function" == typeof n ? n : R_(n);
        return this.select(function () {
    ...
    var _y = function (t) {
        ...
        for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)if ((r = n[i]).identifier === e)return q_(t, r);
        return null
    }, my = function (t, n) {
        null == n && (n = P_().touches);
        for (var e = 0, r = n ? n.length : 0, i = new Array(r); e < r; ++e)i[e] = q_(t, n[e]);
        return i
    }, xy = Pn("start", "end", "interrupt"), by = [], wy = 0, My = 1, Ty = 2, Ny = 3, ky = 4, Sy = 5, Ay = 6, Ey = function (t, n, e, r, i, o) {
        ...
        var e = w_(t), r = "transform" === e ? xp : qy;
        ...
        "function" != typeof t && (t = R_(t));
        for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Ey(l[h], n, e, h, l, Ri(a, e)));
    ...
    }, Xy = Pi.prototype.constructor, Vy = function () {
        ...
        for (var t = this._name, n = this._id, e = lo(), r = this._groups, i = r.length, o = 0; o < i; ++o)for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)if (u = a[s]) {
            var f = Ri(u, n);
            Ey(u, t, e, s, a, {time: f.time + f.delay + f.duration, delay: 0, duration: f.duration, ease: f.ease})
        }
        return new so(r, this._parents, t, e)
    }, Jy = 0, Qy = Pi.prototype;
    ...
    var Ky = {time: null, delay: 0, duration: 250, ease: g}, tg = function (t) {
        var n, e;
        t instanceof so ? (n = t._id, t = t._name) : (n = lo(), (e = Ky).time = jn(), t = null == t ? null : t + "");
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && Ey(u, t, n, s, a, e || ho(u, n));
        return new so(r, this._parents, t, n)
    };
    Pi.prototype.interrupt = zy, Pi.prototype.transition = tg;
    var ng = [null], eg = function (t, n) {
        var e, r, i = t.__transition;
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)if ((e = i[r]).state > My && e.name === n)return new so([[t]], ng, n, +r)
        }
        return null
    }, rg = Array.prototype.slice, ig = function (t) {
        return t
    }, og = 1, ug = 2, ag = 3, cg = 4, sg = 1e-6, fg = function () {
        function t(t) {
            var o, u = 0;
    ...
    var qg = function () {
    ...
    }, Rg = (1 + Math.sqrt(5)) / 2, Ug = function t(n) {
        ...
        var e = Ug, r = !1, i = 1, o = 1, u = [0], a = Go, c = Go, s = Go, f = Go, l = Go;
        return t.round = function (n) {
        ...
        function n() {
            ...
            for (var n, r, c, s, f, l, h, p = i.length, d = 0; d < a; ++d)for (r = I(i, hu, pu).visitAfter(e), n = 0; n < p; ++n)c = i[n], l = o[n], h = l * l, s = c.x + c.vx, f = c.y + c.vy, r.visit(t)
        }
        ...
        function e(n) {
            for (var e = 0, r = t.length; e < v; ++e)for (var i, o, u, s, f, h, p, d = 0; d < r; ++d)i = t[d], o = i.source, u = i.target, s = u.x + u.vx - o.x - o.vx || jg(), f = u.y + u.vy - o.y - o.vy || jg(), h = Math.sqrt(s * s + f * f), h = (h - c[d]) / h * n * a[d], s *= h, f *= h, u.vx -= s * (p = l[d]), u.vy -= f * p, o.vx += s * (p = 1 - p), o.vy += f * p
        }
        ...
        var a, c, s, f, l, h = du, p = n, d = Bg(30), v = 1;
    ...
    }, Vg = 10, Wg = Math.PI * (3 - Math.sqrt(5)), $g = function (t) {
        function n() {
        ...
        var i, o, u, a, c = Bg(-30), s = 1, f = 1 / 0, l = .81;
        ...
        var n = t.document.documentElement, e = _y(t).on("dragstart.drag", Qg, !0);
    ...
    var rm, im, om, um, am, cm = [], sm = [], fm = 1e-6, lm = 1e-12;
    na.prototype = {
    ...
    var vm = function () {
        ...
        function u(t, n, e) {
            t.on("start.zoom", function () {
                ...
                var t = this, r = arguments, i = a(t, r), u = g.apply(t, r), c = e || o(u), s = Math.max(u[1][0] - u[0][0], u[1][1] - u[0][1]), f = t.__zoom, l = "function" == typeof n ? n.apply(t, r) : n, h = Np(f.invert(c).concat(s / f.k), l.invert(c).concat(s / l.k));
                return function (t) {
                    if (1 === t)t = l; else {
                        var n = h(t), e = s / n[2];
        ...
        function s() {
            ...
            if (y.apply(this, arguments)) {
                var o = a(this, arguments), u = this.__zoom, c = Math.max(m, Math.min(x, u.k * Math.pow(2, -t.event.deltaY * (t.event.deltaMode ? 120 : 1) / 500))), s = L_(this);
        ...
        function f() {
            ...
            if (!_ && y.apply(this, arguments)) {
                var o = a(this, arguments), u = _y(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0), c = L_(this);
        ...
        function l() {
            if (y.apply(this, arguments)) {
                var o = this.__zoom, a = L_(this), c = o.invert(a), s = o.k * (t.event.shiftKey ? .5 : 2), f = i(r(e(o, s), a, c), g.apply(this, arguments));
        ...
        var v, _, y = ua, g = aa, m = 0, x = 1 / 0, b = -x, w = x, M = b, T = w, N = 250, k = [], S = Pn("start", "zoom", "end"), A = 500, E = 150;
        ...
        t.event.preventDefault(), t.event.stopImmediatePropagation()
    }, xm = {name: "drag"}, bm = {name: "space"}, wm = {name: "handle"}, Mm = {name: "center"}, Tm = {
        name: "x",
        handles: ["e", "w"].map(fa),
        input: function (t, n) {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, Am = {e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se"}, Em = {
        n: "s",
        s: "n",
        nw: "sw",
        ne: "se",
        se: "ne",
        sw: "nw"
    }, Cm = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1}, zm = {
        overlay: 1,
        selection: 1,
        n: -1,
        e: null,
        ...
        return ga(km)
    }, qm = Math.cos, Lm = Math.sin, Rm = Math.PI, Um = Rm / 2, Dm = 2 * Rm, Om = Math.max, Fm = function () {
        function t(t) {
            var o, u, a, c, s, f, l = t.length, h = [], p = Us(l), d = [], v = [], _ = v.groups = new Array(l), y = new Array(l * l);
            for (o = 0, s = -1; ++s < l;) {
    ...
    }, Im = Array.prototype.slice, Ym = function (t) {
        return function () {
            return t
        }
    }, Bm = function () {
        function t() {
            var t, a = Im.call(arguments), c = n.apply(this, a), s = e.apply(this, a), f = +r.apply(this, (a[0] = c, a)), l = i.apply(this, a) - Um, h = o.apply(this, a) - Um, p = f * qm(l), d = f * Lm(l), v = +r.apply(this, (a[0] = s, a)), _ = i.apply(this, a) - Um, y = o.apply(this, a) - Um;
    ...
    var Hm, Xm, Vm, Wm, $m, Zm, Gm, Jm, Qm, Km, tx, nx, ex, rx, ix, ox, ux, ax, cx, sx, fx, lx, hx, px, dx, vx, _x, yx, gx, mx, xx, bx = new Na, wx = 1e-6, Mx = 1e-12, Tx = Math.PI, Nx = Tx / 2, kx = Tx / 4, Sx = 2 * Tx, Ax = 180 / Tx, Ex = Tx / 180, Cx = Math.abs, zx = Math.atan, Px = Math.atan2, qx = Math.cos, Lx = Math.ceil, Rx = Math.exp, Ux = Math.log, Dx = Math.pow, Ox = Math.sin, Fx = Math.sign || function (t) {
            return t > 0 ? 1 : t < 0 ? -1 : 0
        }, Ix = Math.sqrt, Yx = Math.tan, Bx = {
        ...
        sphere: Ca, point: nc, lineStart: rc, lineEnd: uc,
        polygonStart: function () {
        ...
        var n = px, e = dx, r = vx, i = n * n + e * e + r * r;
    ...
    var eb, rb, ib, ob, ub, ab, cb, sb, fb, lb, hb, pb = function (t) {
        ...
        function n() {
            var t = i.apply(this, arguments), n = o.apply(this, arguments) * Ex, c = u.apply(this, arguments) * Ex;
        ...
        var e, r, i = tb([0, 0]), o = tb(90), u = tb(6), a = {point: t};
    ...
    }, Nb = [null, null], kb = {type: "LineString", coordinates: Nb}, Sb = function (t, n) {
        ...
        var e = t[0] * Ex, r = t[1] * Ex, i = n[0] * Ex, o = n[1] * Ex, u = qx(r), a = Ox(r), c = qx(o), s = Ox(o), f = u * qx(e), l = u * Ox(e), h = c * qx(i), p = c * Ox(i), d = 2 * Aa(Ix(Ea(o - r) + u * c * Ea(i - e))), v = Ox(d), _ = d ? function (t) {
            var n = Ox(t *= d) / v, e = Ox(d - t) / v, r = e * f + n * h, i = e * l + n * p, o = e * a + n * s;
    ...
    }, Fb = 0, Ib = 0, Yb = 0, Bb = 0, jb = 0, Hb = 0, Xb = 0, Vb = 0, Wb = 0, $b = {
        point: Pc,
        lineStart: qc,
        lineEnd: Uc,
        polygonStart: function () {
    ...
    Yc.prototype = {
        ...
        _circle: jc(4.5), pointRadius: function (t) {
    ...
    var Zb = function () {
    ...
    }, Gb = jm(), Jb = function (t, n) {
        var e = n[0], r = n[1], i = [Ox(e), -qx(e), 0], o = 0, u = 0;
        Gb.reset();
        for (var a = 0, c = t.length; a < c; ++a)if (f = (s = t[a]).length)for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + kx, d = Ox(p), v = qx(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
            var y = s[_], g = y[0], m = y[1] / 2 + kx, x = Ox(m), b = qx(m), w = g - h, M = w >= 0 ? 1 : -1, T = M * w, N = T > Tx, k = d * x;
        ...
        return function (i, o) {
            ...
            var p, d, v, _ = n(o), y = i.invert(r[0], r[1]), g = vb(), m = n(g), x = !1, b = {
                point: u,
                lineStart: c,
                lineEnd: s,
                polygonStart: function () {
        ...
        function i(t) {
            ...
            return {
                lineStart: function () {
                    ...
                    var p, d = [l, h], v = r(l, h), _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? Tx : -Tx), h) : 0;
                    if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (yb(n, p) || yb(d, p)) && (d[0] += wx, d[1] += wx, v = r(d[0], d[1]))), v !== i)f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p; else if (s && n && c ^ v) {
                        var y;
    ...
    var ew = 16, rw = qx(30 * Ex), iw = function (t, n) {
        ...
        var e, r, i, o, u, a, c = aw(), s = uw().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), f = uw().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
            point: function (t, n) {
                a = [t, n]
            }
        };
    ...
    var xw = function () {
        var t = ls(ms), n = t.center, e = t.rotate;
